...
| 7    | 2017级-士谔书院-程序设计基础训练 | 完全开放 | <span style="color:red;">**正在更新中**</span> |
| 8    | 2017级-航空航天大类-C语言程序设计<sup>*</sup> | 部分开放 | <span style="color:red;">**更新完毕**</span> |
| 9    | 2018级-士谔书院-程序设计基础训练<sup>*</sup> | 部分开放 | <span style="color:red;">**更新完毕**</span> |
| 10    | 2018级-航空航天大类-C语言程序设计<sup>*</sup> | 部分开放 | <span style="color:red;">**更新完毕**</span> |
| 11   | 2018级-软件学院-算法分析与设计   | 部分开放 | <span style="color:red;">**正在更新中**</span> |
| 12   | 2019级-软件学院-算法分析与设计   | 未开始   | **未开始更新**                                 |

注：目前更新中的课程，除18算法之外已全部整理完毕，仅需要等待上传，有需要的同学可以在短时间内等到及时的更新。标题带有星号的表示其他同学或者助教组整理的pdf格式或其他格式的题解，其余均为笔者本人所著，格式为md题解+源代码。

**注:题解摆放方式与现在的北航OJ课程比赛命名方式类似，C开头代表上机，E开头代表练习赛。**
...
**update0714:为了方便整理,之后上传的题解将全部以md嵌入代码的形式保留，有需要的同学直接进行readme即可。**
...
由于这门课程的开设时间是大一下，所以**不会出现平衡搜索树与左式堆等进阶数据结构。**而由于上机的考查知识点有限，**不会对开散列与闭散列的具体实现进行考察。**
